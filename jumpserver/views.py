...
def index(request):
    ...
    if is_role_request(request, 'user'):
        ...
        #新增功能:树形结构显示公司资产
        data_01 = json.dumps([{"id": "1", "name": "公司1", "parent_id": "0", "depth": "1"},{"id": "2", "name": "部门1", "parent_id": "1", "depth": "2"},{"id": "3", "name": "<a href='/jasset/asset/list/?company_name=公司1&department_name=部门1&business_name=业务1'>业务1</a>", "parent_id": "2", "depth": "3"}]);
