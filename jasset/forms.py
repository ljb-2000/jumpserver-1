...
from jasset.models import IDC, Asset, AssetGroup,CompanyName,DepartmentName,BusinessName
...
class AssetForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            "system_arch","ci001","ci002","principal","email","mobile_phone_number","level","business_name"
        ]
...
class DepartmentNameForm(forms.ModelForm):
    class Meta:
