...
def tree_list(request):
    ...
    if user_perm != 0:
        return my_render('jasset/tree_list.html', locals(), request)
    else:
        return my_render('jasset/asset_cu_list.html', locals(), request)
...
def group_add_xiaoniu(request):
    ...
    return my_render('jasset_xiaoniu/group_add_xiaoniu.html', locals(), request)
...
def group_edit_xiaoniu(request):
    ...
    return my_render('jasset_xiaoniu/group_edit_xiaoniu.html', locals(), request)
...
def group_list_xiaoniu(request):
    ...
    asset_group_list, p, asset_groups, page_range, current_page, show_first, show_end = pages(asset_group_list, request)
    return my_render('jasset_xiaoniu/group_list_xiaoniu.html', locals(), request)
